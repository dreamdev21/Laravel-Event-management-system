                                        ...
                                        <td style="width:180px; text-align: right;">
                                            <div class="ticket-pricing" style="margin-right: 20px;">
                                                ...
                                                @else
                                                    ...
                                                    $is_free_event = false;
                                                    ?>
                                                    <span title='{{money($ticket->price, $event->currency)}} + {{trans('manageevent.ticket-price')}} + {{money($ticket->total_booking_fee, $event->currency)}} {{ trans('common.booking-fee') }}'>{{money($ticket->total_price, $event->currency)}} </span>
