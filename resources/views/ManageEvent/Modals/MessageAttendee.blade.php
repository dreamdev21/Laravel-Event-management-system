        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    ...
                    {{ trans('manageevent.message') }} {{{$attendee->full_name}}}
                </h3>
            </div>
            <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="custom-checkbox">
                                ...
                                <label for="send_copy">&nbsp;&nbsp;{{ trans('manageevent.send-copy-to') }} <b>{{$attendee->event->organiser->email}}</b></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="help-block">
                    {{ trans('manageevent.send-reply-to') }} <b>{{$attendee->event->organiser->email}}</b>
                </div>
            </div> <!-- /end modal body-->
